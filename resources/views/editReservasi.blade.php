        ...
        <form action="{{ route('reservasi')}}" method="POST" class="hotelw-search-form">
          ...
          <div class="tm-form-inner">
            <div class="form-group">
                <select class="form-control" name="id_hotel" value="2">
                  ...
                  <div class="form-group">
                      <div class='input-group date' id='datetimepicker1'>
                          <input type='text' class="form-control"  name="tanggalCheckin" placeholder="Check-in Date" value="{{$reservasi[0]->tgl_check_in}}" />
                  ...
                  <div class="form-group">
                      <div class='input-group date'  id='datetimepicker2'>
                          <input type='text' class="form-control" name="tanggalCheckout" placeholder="Check-out Date" value="{{$reservasi[0]->tgl_check_out}}" />
                          <span class="input-group-addon">
                              <span class="fa fa-calendar"></span>
                          </span>
                      </div>
