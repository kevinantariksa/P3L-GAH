...
<body>
				...
				<ul class="slides">
					<li>
						...
						<div class="contact-text">
							<h2 class="slider-title">Promotion's For every Season</h2>
			...
			<div class="flexslider effect2 effect2-contact tm-contact-box-1">
				<ul class="slides">
					<li>
						<img src="img/world-map.png" alt="image" class="contact-image" />
						<div class="contact-text">
							<h2 class="slider-title">Our Hotel</h2>
							<h3 class="slider-subtitle">Jogjakarta</h3>
							<p class="slider-description"> P. Mangkubumi Street No 18, Yogyakarta <br> +6274 487711<br>
                            Hotel In the middle of town, Ease of access to popular places.</p>
							<div class="slider-social">
								<a href="#" class="tm-social-icon"><i class="fa fa-twitter"></i></a>
								<a href="#" class="tm-social-icon"><i class="fa fa-facebook"></i></a>
								<a href="#" class="tm-social-icon"><i class="fa fa-pinterest"></i></a>
			...
			<div class="flexslider effect2 effect2-contact tm-contact-box-1">
				<ul class="slides">
					<li>
						...
						<div class="contact-text">
							<h2 class="slider-title">Our Hotel</h2>
							<h3 class="slider-subtitle">Bandung </h3>
							<p class="slider-description"> Dago street, Bandung <br> +6222 487711<br>
														Hotel In the middle of town, Ease of access to popular places. </p>
							<div class="slider-social">
								<a href="#" class="tm-social-icon"><i class="fa fa-twitter"></i></a>
								<a href="#" class="tm-social-icon"><i class="fa fa-facebook"></i></a>
	...
	<footer class="tm-black-bg">
		<div class="container">
			<div class="row">
				<p class="tm-copyright-text">Copyright &copy; 2018 SIGAH
	...
	<script>
		/* Google map
      	...
      	function initialize() {
	        var mapOptions = {
	          	zoom: 14,
	          	center: new google.maps.LatLng(-7.7956, 110.3695),
	          	scrollwheel: false
        	};
